...
| ----- | ----- | ----- | ----- |
| <a href="https://github.com/krisswiltshire30/syne">SYNE</a>| Makers Academy final project - Set out to build a music visualiser using the Web Audio API, with a goal to have a GUI that users can manipulate elements to different frequences of audio noises through mic or aux input.| 8 days | HTML, Javascript, Three.js - library |
